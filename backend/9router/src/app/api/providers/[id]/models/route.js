// OptiAI: upstream imported `NextResponse` from "next/server"; only `.json()` was ever used,
// so this shim keeps the rest of the file byte-identical to 9Router without pulling in Next.
