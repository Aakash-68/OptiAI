// OptiAI: node-machine-id is CommonJS. Next's bundler resolved the named import for
// 9Router; plain Node's CJS export detection does not, so destructure the default.
